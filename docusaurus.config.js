...
const config = {
  title: 'Antelope IBC Documentation',
  tagline: 'Antelope Inter-Blockchain Communication smart contract infrastructure developer documentation.',
  ...
  organizationName: 'Antelope', // Usually your GitHub org/user name.
  projectName: 'ibc-docs', // Usually your repo name.
